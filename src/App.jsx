...
// ... спред оператор
    ...
    let hamburgerButtons = [
        { text: 'cheese', img: Cheese, price: 35 },
        { text: 'meat', img: Meat, price: 90 },
...
// чтобы обратится в LocalStorage.setItem(name: String, value)

// useEffect(()  => {}, [])
// [] --> сработает только один разб когда открывается приложение
// [states, server calls] --> будет работать каждый раз когда переданные значение в массив обновляються 
